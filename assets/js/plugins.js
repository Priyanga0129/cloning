...
!(function (i) {
  ...
  ((e = (function () {
    ...
    (e.prototype.swipeHandler = function (i) {
      ...
      if (
        !(
          e.options.swipe === false ||
          ("ontouchend" in document && e.options.swipe === false) ||
          (e.options.draggable === false &&
...
(function () {
  ...
  // ✅ Safe offset call
  const el = this.$element && this.$element.get(0);
...
if (
  ...
  console.warn("❌ Invalid element passed to .refresh()", this.$element);
  return;
}

e = this.$element.offset(); // ✅ Now safe
  this.doScroll();
  ...
  return n.each(t, function (t, e) {
    return n.each(i.waypoints[t], function (t, r) {
      ...
      r.offset = s - e.contextOffset + e.contextScroll - o;

      if ((r.options.onlyOnScroll && l != null) || !r.enabled) return;

      if (l !== null && l < (f = e.oldScroll) && f <= r.offset) {
        return r.trigger([e.backward]);
      } else if (l !== null && l > (a = e.oldScroll) && a >= r.offset) {
